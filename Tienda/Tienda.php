  ...
  class Tienda extends funcionesGlobales
	{
  	...
  	#Atributos
		...
		function salida($idDeTienda, $cliente){
			...
			$result = $mysqli->query("SELECT * FROM tiendaCliente WHERE idCliente LIKE '$cliente' AND accion LIKE 'Dentro' "); 
		...
		function dameTienda($a, $cliente, $ipCliente, $idCliente, $idMen, $horaEntrada){
			  envios::envioTienda($a, $ipCliente, $idCliente, $idMen, $horaEntrada);
		}
	}
?>
