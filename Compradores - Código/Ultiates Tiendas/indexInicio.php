<?php
	...
	class Inicializador
	{
      ...
      $result = $mysqli->query("CREATE TABLE tiendasConocidas (ipIdCliente VARCHAR(20), idTiendaDentro VARCHAR(20), idTiendaConocida VARCHAR(20), ipTiendaConocida VARCHAR(20))");
			...
			for($i = 0; $i < 100; ++$i) {
        $precio = random_int(1, 10);
				$result = $mysqli->query("INSERT INTO productos (Id, Nombre, Cantidad, Precio) VALUES ($i, 'product$i', 30, $precio)");
			}
